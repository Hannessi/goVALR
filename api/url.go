...
func (u *urlManager) GetCurrencyPairs() string {
	return u.baseUrl + "public/pairs"
}

func (u *urlManager) GetOrderTypes() string {
	return u.baseUrl + "public/ordertypes"
}

func (u *urlManager) GetOrderTypesForCurrencyPair(currencyPair string) string {
	return u.baseUrl + "public/" + currencyPair + "/ordertypes"
}

func (u *urlManager) GetMarketSummary() string {
	return u.baseUrl + "public/marketsummary"
}

func (u *urlManager) GetMarketSummaryForCurrencyPair(currencyPair string) string {
	return u.baseUrl + "public/" + currencyPair + "/marketsummary"
}

func (u *urlManager) GetPublicTradeHistory(currencyPair string, skip, limit int, startTime, endTime time.Time, beforeId string) string {
	url := u.baseUrl + "public/" + currencyPair + "/trades"
...
func (u *urlManager) GetServerTime() string {
	return u.baseUrl + "public/time"
}

func (u *urlManager) GetValrStatus() string {
	return u.baseUrl + "public/status"
}
